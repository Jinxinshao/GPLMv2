...
parser.add_argument('--save_dir', default='./saved_models/real_FiLM6_FPN_TA_CSAM_add_mul_newmlp/', type=str, help='path to models saving')
parser.add_argument('--data_dir', default='/public/home/shaojx8/Restormer-main/Defocus_Deblurring', type=str, help='path to dataset')
parser.add_argument('--log_dir', default='./logs/', type=str, help='path to logs')
parser.add_argument('--dataset', default='Datasets', type=str, help='dataset name')
...
if __name__ == '__main__':
	setting_filename = os.path.join('configs', args.exp, args.model+'-EUVP.json')
	...
	# checkpoint=torch.load('/public/home/shaojx8/MixDehaceNet_new_6_new/saved_models/real_FiLM6_FPN_TA_CSAM_add_mul/indoor/MixDehazeNet-sreal_FiLM6_FPN_TA_CSAM_add_mul.pth')
		...
		if epoch % setting['eval_freq'] == 0:
			...
			if avg_psnr > best_psnr:
				...
				torch.save({'state_dict': network.state_dict(),
						   ...
						   os.path.join(save_dir, args.model+'real_FiLM6_FPN_TA_CSAM_add_mul_newmlp.pth'))
