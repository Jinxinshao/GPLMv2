...
from datasets.loader_UFO import PairLoader
...
parser.add_argument('--save_dir', default='./saved_models/real_FiLM6_FPN_TA_CSAM_add_mul_UFO/', type=str, help='path to models saving')
parser.add_argument('--data_dir', default='/public/home/shaojx8/palette-mask2/datasets/UFO-120/', type=str, help='path to dataset')
...
if __name__ == '__main__':
	setting_filename = os.path.join('configs', args.exp, args.model+'-UFO.json')
	...
	checkpoint=torch.load('/public/home/shaojx8/MixDehaceNet_new_6_new/saved_models/real_FiLM6_FPN_TA_CSAM_add_mul_UFO/indoor/MixDehazeNet-sreal_FiLM6_FPN_TA_CSAM_add_mul_UFO.pth')
	...
	# CosineAnnealingLR
 	# T_0=10, T_mult=2, eta_min=setting['lr'] * 1e-3
		...
		if epoch % setting['eval_freq'] == 0:
			...
			if avg_psnr > best_psnr:
				...
				torch.save({'state_dict': network.state_dict(),
						   ...
						   os.path.join(save_dir, args.model+'real_FiLM6_FPN_TA_CSAM_add_mul_UFO.pth'))
