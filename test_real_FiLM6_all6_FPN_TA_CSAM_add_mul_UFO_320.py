...
parser.add_argument('--result_dir', default='./results/real_FiLM6_FPN_TA_CSAM_add_mul_UFO_320/', type=str, help='path to results saving')
...
if __name__ == '__main__':
	...
	network.cuda()
	saved_model_dir = os.path.join(args.save_dir, args.exp, 'MixDehazeNet-sreal_FiLM6_FPN_TA_CSAM_add_mul_UFO.pth')
